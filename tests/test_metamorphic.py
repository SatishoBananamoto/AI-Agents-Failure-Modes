    ...
    "evidence": [
        {
            ...
            "source_type": "spec",
            "url": "internal://x",
            "quote": "A factual claim with evidence.",
            "as_of_date": "2026-05-02",
        ...
        },
        {
            ...
            "quote": "Mapped evidence exists for C1 in this fixture.",
            "as_of_date": "2026-05-02",
            "supports_claim_ids": ["C1"],
        },
    ],
...
def test_unrelated_metadata_does_not_change_verdict():
    mutated = deepcopy(BASE)
    mutated["metadata"]["note"] = "non-verifier metadata should not affect v0.3 verdict"
